...
export default function About() {
  ...
  return (
    <div className={styles.parent}>
      <AdminCardParent>
        <div
          style={{ display: "grid", justifyContent: "center", rowGap: "10px" }}
        >
          <TextArea
            style={{ minHeight: "150px", maxWidth: "750px", width: "50vw" }}
            placeholder={"О нас"}
          />
                  ...
                  <>
                    <div style={{ display: "grid", rowGap: "10px" }}>
                      <div className={styles.firstContent}>
                        ...
                        <div>
                          <img
                            src="/static/images/icons8-edit.svg"
                            style={{
                              width: "20px",
                              height: "15x",
                              cursor: "pointer",
                  ...
                  <>
                    <div style={{ display: "grid", rowGap: "10px" }}>
                      <div className={styles.firstContent}>
                        ...
                        <div>
                          <img
                            src="/static/images/icons8-save-90.png"
                            style={{
                              width: "20px",
                              height: "15x",
                              cursor: "pointer",
