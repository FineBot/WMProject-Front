                    ...
                    <div className={"centre"} >
                        <div style={{width:"100%"}}>
                            <h1 style={{color:"black"}}>
                               ...
                               <div style={{marginLeft:"auto",marginRight:"auto",display:"block",width:"95%",textAlign:"center"}}>
                                   <input placeholder={"Начните вводить"} id={"searchInput"} onChange={(e)=>{
                                                ...
                                                return(
                                                    <a target={"_blank"} href={"/article/"+e['id']}>
                                                        <div style={{marginBottom:"10px",width:"100%"}}>
                                                            <div className={"tabs"} style={{marginTop:"5px",marginRight:"5px",cursor:"pointer",borderRadius:"10px",width:"100%",
